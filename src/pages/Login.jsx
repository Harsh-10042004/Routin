  ...
  return (
    <div className='grid grid-cols-2'>
      ...
      <div className='flex items-center justify-center flex-col'>
        <form className='w-lg flex flex-col animate__animated animate__heartBeat'>
          ...
          <button className='bg-linear-to-r from-blue-500 to-indigo-500 text-white font-medium py-3 rounded-lg'>Sign in</button>
        </form>
